...
public class Tela extends javax.swing.JFrame {
        ...
        pan_ScriptLayout.setHorizontalGroup(
            ...
            .addGroup(pan_ScriptLayout.createSequentialGroup()
                ...
                .addGroup(pan_ScriptLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pan_ScriptLayout.createSequentialGroup()
                        .addGroup(pan_ScriptLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txf_OnEquip, javax.swing.GroupLayout.PREFERRED_SIZE, 380, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txt_OnEquip))
                        .addGap(18, 18, 18)
                        .addGroup(pan_ScriptLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txt_OnUnequip)
                            .addComponent(txf_OnUnequip, javax.swing.GroupLayout.PREFERRED_SIZE, 380, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addContainerGap())
        );
    ...
    public void setLangPT(){ // void to set the language to portuguese
        ...
        //Script
        txt_Normal.setText("Script Normal");
    ...
    public void setLangEn(){ // void to set the language to english
        txt_AegisName.setText("");
        txt_AmmoType.setText("");
        txt_Attack.setText("");
        txt_Buy.setText("");
        txt_Defense.setText("");
        txt_EquipLevel.setText("");
        txt_Gender.setText("");
        txt_ID.setText("");
        txt_ItemType.setText("");
        txt_Name.setText("");
        txt_Range.setText("");
        txt_Refinable.setText("");
        txt_Sell.setText("");
        txt_ShieldType.setText("");
        txt_Slot.setText("");
        txt_ViwerID.setText("");
        txt_WeaponLVL.setText("");
        txt_Weight.setText("");
        //Script
        txt_Normal.setText("");
        txt_OnEquip.setText("");
        txt_OnUnequip.setText("");
    }
